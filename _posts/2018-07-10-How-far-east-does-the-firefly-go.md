...
But even with this extension of the known geographic range of *P. pyralis* fireflies well into Connecticut, potentially saving me several hours of driving off future firefly collection trips, **I was still left with a burning question...** 
# How far east does the firefly go?

The question of where the edge of the geographic range for a species falls, is both a bit ephemeral, in the sense that the edge of the species range is always moving based on movement of said species, or on year-to-year variation in climate or ecological conditions which prune-back or expand a population, and concrete, in the sense that there *is* a real edge to a species geographic range at any given time.

A trivial answer to this question of how far east the geographic distribution of fireflies goes in the USA is: all the way east, which is to say, many *Photinus*, *Photuris*, *Pyractomena*, *Lucidota*, and *Ellychnia* genus fireflies are found throughout Massachusetts, and into Maine (and beyond). But, those fireflies aren't *'the firefly'*, by which of course I mean my favorite species, *Photinus pyralis*.
...
As for the ephemeral yet concretely fascinating question of how far (north)east the *P. pyralis* population goes, in a discussion via Twitter, @galos_gann kicked off this blog post deep dive by [reporting](https://twitter.com/galos_gann/status/1015805834436272128) that he hadn't seen any *P. pyralis* in Rumsford, Rhode Island in early July of 2018.
...
**The geographic distribution of *Photinus pyralis* is constrained by climactic conditions. Rhode Island and New Haven, while they might seem similar, are climatically different enough by firefly standards that *P. pyralis* can't survive well in RI**
...
On the map below, each point represents a *P. pyralis* sighting (most likely the signaling adult males). Onto those points, I've overlaid labels with the date of sighting, the 30-year normal minimum average temperature (from PRISM, in ˚C), and the 2017 average minimum temperature (also from PRISM, in ˚C):
...
Applying these expectations: even though we don't have direct data for the presence of *P. pyralis* all the way out west on Long Island, it seems the northern coast of Long Island should have *P. pyralis* all the way out to the western edge (Figure 5). Analogously, the southern 'Pine Barren' ecoregion of Long Island may not have *P. pyralis*.
...
1. Using the simple criteria that sites which are contiguous in ecoregion climate with known sites of *P. pyralis* observations should be included in a reasonable extrapolation of the species range, the distributions of climatic conditions and the WWF Ecoregion classification between known *P. pyralis* populations in CT and areas without known *P. pyralis* populations in Rhode Island (Figure 5), suggests that Rhode Island's climate and ecosystem conditions are compatible with robust *P. pyralis* populations. **I therefore reject the hypothesis that the climate in Rhode Island is not suitable for *P. pyralis*. Seems warm enough along the coast, and should have the right earthworms (ecoregion) for the fireflies to eat!** That being said, by this same shared climate/ecoregion criteria, there should also be *P. pyralis* populations in south-eastern Massachusetts, and possibly just south of Boston! Seems unlikely that these Massachusetts populations wouldn't have been reported at all, so there may be alternative factors and hypotheses to explain why *P. pyralis* may not be in every location that this simple shared climate/ecoregion criteria would predict them to be:

A first alternative hypothesis: Although the climate along the New England coast is suitable for *P. pyralis*, perhaps the local ecosystems are quite different (e.g. not enough earthworms and/or different earthworm species that *P. pyralis* don't like, and/or key predators that show up further north). Unlike the PRISM climate model (which I think is relatively reliable), there is almost certainly much more local variation in ecosystem composition, and subtle variation in ecosystems may be quite important for successful expansions of *P. pyralis*. Without having a better understanding of what exactly *P. pyralis* larvae eat, what their other major ecological interactions are, and how these ecosystems vary up the New England coast, hard to say much more.

A second alternative hypothesis to explain why *P. pyralis* don't extend up the New England coast despite 'suitable' conditions could be dispersal dynamics: *P. pyralis* seem to be better adapted towards meadow-like and/or disrupted forest-edge habitats.  If there is a very thick/dense forest, this might act as a barrier to *P. pyralis* dispersal, and as an example that would keep them from dispersing from one meadow to a fairly new meadow on the other side of the forest. That being said, society has produced impromptu meadows all over the place with suburbia, interstate highways, high-voltage power lines, and your bog-standard roads, so it seems like *P. pyralis* should generally be able to get most places where humans are.

## Part 6: Future directions

The only path to solving this question of the distribution of *P. pyralis* along the New England coast seems to be to get more data! An interesting avenue is the continuing use of [iNaturalist](www.inaturalist.org), so far has been a pretty powerful powerful method to easily gain new species observations from large areas. *P. pyralis* is also a bit unique amongst fireflies in that it has key characteristics which make identification via photo or video of the flash pattern possible.

Given the interesting result in Figure 5, in which the Pioneer Valley in Connecticut and Massachusetts might be suitable for *P. pyralis*, a personal goal for this summer is drive out to Western MA and check sites along the Connecticut river for *P. pyralis*. From a dispersal perspective, as this river valley has been well-settled and farmed for centuries, I think it is pretty likely that it has been friendly to *P. pyralis* dispersal for a long time. The recent (<10 year?) warming of the River Valley might have allowed *P. pyralis* populations to expand up its banks.

But beyond that, technically I'm a biochemist, not a ecologist! So I will likely not get much deeper into questions of the *P. pyralis* ecological niche and geographic distribution than this blog post and continuing to update the spreadsheet[^spreadsheet] with confident *P. pyralis* presence or absence records. But, I hope it at least stirs some interest in my very capable and more ecologically oriented colleagues to address these questions.
